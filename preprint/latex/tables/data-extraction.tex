...
\hline
\textbf{Ref.} &
\rotatebox{90}{\textbf{appearance}} & \rotatebox{90}{\textbf{dynamic}} & \rotatebox{90}{\textbf{sparsity}} & \rotatebox{90}{\textbf{multi-session}} & \rotatebox{90}{\textbf{computational}} &
\textbf{localization} &
\textbf{mapping} &
\rotatebox{90}{\textbf{multi-robot}} &
...
\textbf{sensor} &
\rotatebox{90}{\textbf{exp. self-acq.}} &
\textbf{ground-truth} &
\rotatebox{90}{\textbf{dist.} (km)} & \rotatebox{90}{\textbf{path} (km)} & \rotatebox{90}{\textbf{time} (h)} & \rotatebox{90}{\textbf{int.} (d/w/m/y)} &
\textbf{datasets} &
\textbf{metrics}\\
\hline
\endfirsthead
